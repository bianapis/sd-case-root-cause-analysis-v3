...
/**
 * BQOperationsandServicingIssueAnalysisInitiateOutputModel
 */
public class BQOperationsandServicingIssueAnalysisInitiateOutputModel   {
  private String operationsandServicingIssueAnalysisInstanceReference = null;

  private String operationsandServicingIssueAnalysisInitiateActionReference = null;

  private Object operationsandServicingIssueAnalysisInitiateActionRecord = null;

  private String operationsandServicingIssueAnalysisInstanceStatus = null;
  ...
  **/
   ...
   * @return operationsandServicingIssueAnalysisInitiateActionReference
  **/

  public String getOperationsandServicingIssueAnalysisInitiateActionReference() {
    return operationsandServicingIssueAnalysisInitiateActionReference;
  }

  public void setOperationsandServicingIssueAnalysisInitiateActionReference(String operationsandServicingIssueAnalysisInitiateActionReference) {
    this.operationsandServicingIssueAnalysisInitiateActionReference = operationsandServicingIssueAnalysisInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Operations and Servicing Issue Analysis instance (e.g. initialised, pending, active) 
   * @return operationsandServicingIssueAnalysisInstanceStatus
  **/

  public String getOperationsandServicingIssueAnalysisInstanceStatus() {
    return operationsandServicingIssueAnalysisInstanceStatus;
  }

  public void setOperationsandServicingIssueAnalysisInstanceStatus(String operationsandServicingIssueAnalysisInstanceStatus) {
    this.operationsandServicingIssueAnalysisInstanceStatus = operationsandServicingIssueAnalysisInstanceStatus;
  }
