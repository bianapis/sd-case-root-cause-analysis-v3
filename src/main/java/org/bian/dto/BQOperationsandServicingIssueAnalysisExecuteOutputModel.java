...
/**
 * BQOperationsandServicingIssueAnalysisExecuteOutputModel
 */
public class BQOperationsandServicingIssueAnalysisExecuteOutputModel   {
  ...
  private String operationsandServicingIssueAnalysisExecuteActionTaskReference = null;

  private Object operationsandServicingIssueAnalysisExecuteActionTaskRecord = null;

  private String operationsandServicingIssueAnalysisExecuteRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Operations and Servicing Issue Analysis instance execute service call 
   * @return operationsandServicingIssueAnalysisExecuteActionTaskReference
  **/

  public String getOperationsandServicingIssueAnalysisExecuteActionTaskReference() {
    return operationsandServicingIssueAnalysisExecuteActionTaskReference;
  }

  public void setOperationsandServicingIssueAnalysisExecuteActionTaskReference(String operationsandServicingIssueAnalysisExecuteActionTaskReference) {
    this.operationsandServicingIssueAnalysisExecuteActionTaskReference = operationsandServicingIssueAnalysisExecuteActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The execute service call consolidated processing record 
   * @return operationsandServicingIssueAnalysisExecuteActionTaskRecord
  **/

  public Object getOperationsandServicingIssueAnalysisExecuteActionTaskRecord() {
    return operationsandServicingIssueAnalysisExecuteActionTaskRecord;
  }

  public void setOperationsandServicingIssueAnalysisExecuteActionTaskRecord(Object operationsandServicingIssueAnalysisExecuteActionTaskRecord) {
    this.operationsandServicingIssueAnalysisExecuteActionTaskRecord = operationsandServicingIssueAnalysisExecuteActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Operations and Servicing Issue Analysis execute transaction/record 
   * @return operationsandServicingIssueAnalysisExecuteRecordReference
  **/

  public String getOperationsandServicingIssueAnalysisExecuteRecordReference() {
    return operationsandServicingIssueAnalysisExecuteRecordReference;
  }

  public void setOperationsandServicingIssueAnalysisExecuteRecordReference(String operationsandServicingIssueAnalysisExecuteRecordReference) {
    this.operationsandServicingIssueAnalysisExecuteRecordReference = operationsandServicingIssueAnalysisExecuteRecordReference;
  }
