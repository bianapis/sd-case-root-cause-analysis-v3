...
/**
 * BQCreditandFraudRelatedIssueAnalysisInitiateOutputModel
 */
public class BQCreditandFraudRelatedIssueAnalysisInitiateOutputModel   {
  private String creditandFraudRelatedIssueAnalysisInstanceReference = null;

  private String creditandFraudRelatedIssueAnalysisInitiateActionReference = null;

  private Object creditandFraudRelatedIssueAnalysisInitiateActionRecord = null;

  private String creditandFraudRelatedIssueAnalysisInstanceStatus = null;
  ...
  **/
   ...
   * @return creditandFraudRelatedIssueAnalysisInitiateActionReference
  **/

  public String getCreditandFraudRelatedIssueAnalysisInitiateActionReference() {
    return creditandFraudRelatedIssueAnalysisInitiateActionReference;
  }

  public void setCreditandFraudRelatedIssueAnalysisInitiateActionReference(String creditandFraudRelatedIssueAnalysisInitiateActionReference) {
    this.creditandFraudRelatedIssueAnalysisInitiateActionReference = creditandFraudRelatedIssueAnalysisInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Credit and Fraud Related Issue Analysis instance (e.g. initialised, pending, active) 
   * @return creditandFraudRelatedIssueAnalysisInstanceStatus
  **/

  public String getCreditandFraudRelatedIssueAnalysisInstanceStatus() {
    return creditandFraudRelatedIssueAnalysisInstanceStatus;
  }

  public void setCreditandFraudRelatedIssueAnalysisInstanceStatus(String creditandFraudRelatedIssueAnalysisInstanceStatus) {
    this.creditandFraudRelatedIssueAnalysisInstanceStatus = creditandFraudRelatedIssueAnalysisInstanceStatus;
  }
